...
include_once "verifica_adm.php";   // garante admin logado
include_once "alerta.php";         // função mostrarAlerta()
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand d-flex align-items-center" href="admin_dashboard.php">
      ...
      <strong>Barbearia La Mafia</strong> — Admin
    </a>
    <div class="d-flex gap-2">
      <a href="admin_dashboard.php" class="btn btn-outline-light btn-sm"><i class="bi bi-house-door"></i> Início</a>
